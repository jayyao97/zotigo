...
// Frozen compatibility bridge for catalogs created before SQL migrations.
// Preserve its historical backfills and partial-schema handling. New versions
