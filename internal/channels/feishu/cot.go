...
func (c *cotClient) Create(ctx context.Context, in channels.InboundMessage) (channels.DeliveryReceipt, error) {
	...
	return channels.DeliveryReceipt{Mode: channels.ProgressModeCOT, MessageID: resp.Data.MessageID, COTID: resp.Data.COTID}, nil
}
...
func openCOTProgress(ctx context.Context, api cotAPI, finalReply func(context.Context, string, string, string) (string, error), in channels.InboundMessage) (channels.ProgressHandle, error) {
...
func resumeCOTProgress(api cotAPI, finalReply func(context.Context, string, string, string) (string, error), receipt channels.DeliveryReceipt) channels.ProgressHandle {
...
func (h *cotProgressHandle) Complete(ctx context.Context, result channels.TaskResult, persistFinal func(string) error) error {
	...
	finalID, err := h.finalReply(ctx, h.originID, result.Text, "zotigo-final-"+h.originID)
	if err != nil {
